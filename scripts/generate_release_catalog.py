...
def parse_args():
    parser = argparse.ArgumentParser(description='Generate CrossInknhanced release catalog JSON.')
    parser.add_argument(
        '--firmware',
        required=True,
        action='append',
...
def main():
    ...
    notes = args.notes or f'CrossInknhanced {version} {args.channel} firmware'
