...
class LookedUpWordsActivity final : public Activity {
 public:
  explicit LookedUpWordsActivity(GfxRenderer& renderer, MappedInputManager& mappedInput, std::string bookLanguage,
                                 std::string bookCachePath, const char* dictionaryFontFamilyName = nullptr,
