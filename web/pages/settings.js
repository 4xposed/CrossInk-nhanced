let allSettings = [];
  ...
  function renderOpdsServer(srv, idx) {
    ...
    return '<div class="opds-server" id="opds-' + id + '">' +
      ...
      '<div class="setting-row">' +
        ...
        '<span class="setting-control"><input type="text" id="opds-folder-' + id + '" value="' + escapeHtml(srv.downloadFolder || '') + '" placeholder="SD root"></span>' +
      '</div>' +
      '<div class="opds-actions">' +
  ...
  function addOpdsServer() {
    ...
    addBtn.insertAdjacentHTML('beforebegin',
      renderOpdsServer({name:'',url:'',username:'',hasPassword:false,filenameFormat:'author_title',downloadFolder:''}, -1));
  }
